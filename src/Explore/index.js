        ...
        <FlatList
          ...
          ListHeaderComponent={() => (
            <>
              <Header />
              <ContainerCategory>
                <CategoryBtn BgColor="#ab2e3e">
                  <IconMT name="fire" size={22} color="#fff" />
                  <TxtBtn>Em alta</TxtBtn>
                </CategoryBtn>
                <CategoryBtn BgColor="#299188">
                  <IconMT name="music" size={22} color="#fff" />
                  <TxtBtn>Música</TxtBtn>
                </CategoryBtn>
                <CategoryBtn BgColor="#a37464">
                  <IconMT name="youtube-gaming" size={22} color="#fff" />
                  <TxtBtn>Jogos</TxtBtn>
                </CategoryBtn>
                <CategoryBtn BgColor="#094c90">
                  <IconMT name="newspaper" size={22} color="#fff" />
                  <TxtBtn>Notícias</TxtBtn>
                </CategoryBtn>
                <CategoryBtn>
                  <IconMT name="home-circle" size={22} color="#fff" />
                  <TxtBtn>#Comigo</TxtBtn>
                </CategoryBtn>
              </ContainerCategory>
              <HeaderUp>
                <TxtHeader>Vídeos em alta</TxtHeader>
              </HeaderUp>
            </>
          )}
          renderItem={({item}) => (
